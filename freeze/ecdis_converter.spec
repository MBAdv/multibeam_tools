...
#
# pyinstaller --clean -y ecdis_converter.spec
#
...
from multibeam_tools.apps.ecdis_converter import __version__ as ft_version
...
icon_file = os.path.abspath(os.path.join('freeze', 'ecdis_converter.ico'))

if is_darwin:
    icon_file = os.path.join('freeze', 'ecdis_converter.icns')

a = Analysis(['ecdis_converter.py'],
             pathex=[],
...
exe = EXE(pyz,
          ...
          name='ecdis_converter.%s' % ft_version,
          debug=False,
          strip=None,
          upx=True,
          console=True,
