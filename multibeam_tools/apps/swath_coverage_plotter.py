...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def set_left_layout(self):
        ...
        source_btn_layout = BoxLayout([self.add_file_btn, self.get_indir_btn, self.get_outdir_btn,
                                       self.rmv_file_btn, self.clr_file_btn, self.show_path_chk], 'v')
    ...
    def set_right_layout(self):
        ...
        self.model_cbox = ComboBox(model_list, 100, 20, 'model_cbox', 'Select the model')
        ...
        self.angle_gb = GroupBox('Angle (deg)', angle_layout, False, False, 'angle_gb')
